    ...
    <header className="fixed w-full top-0 z-50 bg-white p-4 py-2 flex justify-between items-center">
      ...
      <NavigationMenu className="hidden md:block">
        <NavigationMenuList className="gap-8">
          ...
          <NavigationMenuItem>
            <Link href="/docs" legacyBehavior passHref>
              <NavigationMenuLink className="text-lg">Blog</NavigationMenuLink>
            </Link>
          </NavigationMenuItem>
          <NavigationMenuItem>
            <Link href="/docs" legacyBehavior passHref>
              <NavigationMenuLink className="text-lg">FAQ</NavigationMenuLink>
            </Link>
          </NavigationMenuItem>
        </NavigationMenuList>
      </NavigationMenu>
      <div className="cursor-pointer text-md font-bold ring-1 px-4 py-3 rounded-md text-[#1a91f0] ring-[#1a91f0] hover:bg-blue-100">
        My Account
      </div>
    </header>
  );
